-- Historical game replays should not appear on leaderboard.
-- Keep archive/stats persistence while restricting leaderboard placement
-- to games completed on their live day/week.

alter table public.played_games
...
create index if not exists idx_played_games_leaderboard_winners
  ...
  where did_win = true and leaderboard_eligible = true;
